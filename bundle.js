...
/***/ function(module, exports, __webpack_require__) {
	...
	var Board = __webpack_require__(157);

	React.render(React.createElement(Board, null), document.getElementById("content"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Row = __webpack_require__(158);
	var VictoryButton = __webpack_require__(160);
	...
	module.exports = React.createClass({ displayName: "module.exports",
	  ...
	  buildBoard: function buildBoard(size, cb) {
	    var board = [];
	  ...
	  applyMove: function applyMove(board, row, col) {
	    var cb = arguments[3] === undefined ? function (lit) {} : arguments[3];

	    var adjacent = function adjacent(r, c) {
	      var rows = Math.abs(row - r),
	          cols = Math.abs(col - c);

	      return rows == 0 && cols == 0 || rows == 1 && cols == 0 || rows == 0 && cols == 1;
	    };

	    return this.buildBoard(board.length, function (r, c) {
	      var lit = board[r][c] ^ adjacent(r, c);
	      cb(lit);
	      return lit;
	    });
	  },

	  randomBoard: function randomBoard(size) {
	    var board = this.buildBoard(size, function (r, c) {
	      return false;
	    }),
	  ...
	  lightClicked: function lightClicked(row, col) {
	    var victory = true;

	    this.setState({
	      data: this.applyMove(this.state.data, row, col, function (lit) {
	  ...
	  render: function render() {
	    ...
	    return React.createElement("div", { className: classes }, rows, React.createElement(Menu, {
	      moves: this.state.moves,
	      size: this.state.size,
	      toggleSize: this.toggleSize,
	      reset: this.reset }), React.createElement(VictoryButton, { clickHandler: this.reset }));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Light = __webpack_require__(159);
	...
	module.exports = React.createClass({ displayName: "module.exports",
	  render: function render() {
	    ...
	    for (var col = 0; col < this.props.lights.length; col++) {
	      light = React.createElement(Light, {
	    ...
	    return React.createElement("div", { className: "row" }, lights);
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "module.exports",
	  ...
	  render: function render() {
	    ...
	    return React.createElement("span", { className: classes, onClick: this.clicked });
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "module.exports",
	  render: function render() {
	    return React.createElement("div", { className: "victory-button", onClick: this.props.clickHandler }, "VICTORY");
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = React.createClass({ displayName: "module.exports",
	  render: function render() {
	    return React.createElement("p", null, React.createElement("span", null, "Moves: ", this.props.moves), React.createElement("span", null, " | "), React.createElement("span", null, React.createElement("a", { onClick: this.props.toggleSize }, this.props.size, String.fromCharCode(215), this.props.size)), React.createElement("span", null, " | "), React.createElement("span", null, React.createElement("a", { onClick: this.props.reset }, "Reset")));
	  }
	});
